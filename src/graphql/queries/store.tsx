...
export const ListCompanyProductsGQL = gql`
	query listCompanyProducts($companyId: Uuid!, $after: String, $first: Int, $queryText: String!) {
		listCompanyProducts(companyId: $companyId, after: $after, first: $first, query: $queryText) {
			pageInfo {
				endCursor
				hasNextPage
				hasPreviousPage
...
export const ListCompanyCategoriesGQL = gql`
	query listCompanyCategories($companyId: Uuid!, $after: String, $first: Int, $queryText: String!) {
		listCompanyCategories(companyId: $companyId, after: $after, first: $first, query: $queryText) {
			pageInfo {
				endCursor
				hasNextPage
				hasPreviousPage
...
export const ListCompanyOptionsGQL = gql`
	query listCompanyOptions($companyId: Uuid!, $after: String, $first: Int, $queryText: String!) {
		listCompanyOptions(companyId: $companyId, after: $after, first: $first, query: $queryText) {
			pageInfo {
				endCursor
				hasNextPage
				hasPreviousPage
