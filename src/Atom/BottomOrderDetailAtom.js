    ...
    return (
      <View>
        <ListItem style={styles.redList}>
          ...
          <Right>
            <Text style={styles.whiteTextR}>#11,350.00</Text>
          </Right>
        </ListItem>
        <ListItem style={styles.whiteList}>
          ...
          <Right>
            <Text style={styles.blackTextR}>#6,000.00</Text>
          </Right>
        </ListItem>
        <ListItem style={styles.whiteList}>
          <Left>
          ...
          <Right>
            <Text style={styles.redTextR}>#5,350.00</Text>
          </Right>
        </ListItem>
        <ListItem style={styles.whiteList}>
          <Left>
          ...
          <Right>
            <Text style={styles.blackTextR}>02-21-2018</Text>
          </Right>
        </ListItem>
      </View>
    )
