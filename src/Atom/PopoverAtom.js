                    ...
                    {(
                        ...
                        <React.Fragment>
                            <TouchableOpacity
                                ...
                                onPress={openPopover}
                            >
                                <Text style={styles.popoverRedClick}>
                                    {this.props.tag}
                                </Text>
                                <Icon
                                    style={styles.popoverIconTouch}
                                ...
                                <View style={styles.popoverColumn}>
                                    <View style={styles.popoverRow}>
                                        <View style={styles.popoverMainFirst}>
                                            ...
                                            <Text style={styles.popoverTextX}>
                                                Pending
                                            </Text>
                                        </View>
                                        <View style={styles.popoverMainFirst}>
                                    ...
                                    <View style={styles.popoverNotMain}>
                                        <Left style={styles.popoverLeftSide}>
                                            <View
                                                style={styles.popoverInnerLeft}
                                            />
                                            <Text
                                                style={
                                                    styles.popoverInnerLeftText
                                                }
                                            >
                                                Delivered
                                            </Text>
                                        ...
                                        <Right style={styles.popoverRightSide}>
                                            ...
                                            />
                                            <Text style={styles.popoverRecall}>
                                                Recalled
                                            </Text>
                                        </Right>
                                    </View>
